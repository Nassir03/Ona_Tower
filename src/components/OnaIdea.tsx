...
export const OnaIdea: React.FC<OnaIdeaProps> = ({
  ...
  return (
    <section
      id="ona-idea"
      className="relative w-full bg-[#302A26] pt-36 sm:pt-44 pb-24 sm:pb-36 lg:pb-48 text-[#E7DED6]"
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div className="max-w-3xl mb-16 sm:mb-24">
          <h2 className="font-display text-section-headline font-light text-[#F5F0EA] leading-none uppercase mb-4 tracking-tight">
        ...
        >
          <div className="lg:col-span-5 order-2 lg:order-1">
            ...
            <span className="font-script text-2xl sm:text-3xl text-[#C3A68B] block mb-4">
              Wellbeing · Connection · Everyday Pleasure
            </span>
            <h3 className="font-display text-section-headline font-light text-[#F5F0EA] leading-none mb-6">
              Live.
            </h3>
            <p className="font-sans text-base text-[#E7DED6] leading-relaxed mb-8 max-w-md font-light">
            ...
            <button
              ...
              className="inline-flex items-center font-sans text-xs font-semibold tracking-[0.2em] uppercase text-[#F5F0EA] hover:text-[#FFFFFF] transition-colors border-b border-[#A58A71]/50 pb-1 cursor-pointer"
            >
              Discover Residences →
            </button>
          </div>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <div className="relative aspect-[4/3] sm:aspect-[16/10] overflow-hidden bg-[#38312C] rounded-sm border border-[#403832] shadow-2xl">
              <img
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#302A26]/60 via-transparent to-transparent pointer-events-none" />
            </div>
          </div>
        </div>
        ...
        <div className="pt-16 sm:pt-24 border-t border-[#403832] text-center max-w-3xl mx-auto">
          <p className="font-sans text-xs font-semibold tracking-[0.3em] uppercase text-[#A58A71] mb-2">
            LIVE &middot; LIFE &middot; BEYOND
          </p>
          <p className="font-script text-3xl sm:text-4xl text-[#C3A68B] mb-3">
            Two towers. Two perspectives.
          </p>
          <h4 className="font-display text-editorial-statement font-light text-[#F5F0EA] uppercase">
