...
export const LifestyleStory: React.FC = () => {
  ...
  return (
    <section
      ...
      aria-label="Life at ONA — Hospitality, Wellness and Community"
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 sm:mb-20 gap-8">
          <div>
            ...
            <p className="font-sans text-base sm:text-lg text-[#D7D0C5] max-w-xl font-normal">
              Rooftop terrace swimming pool, indoor and outdoor restaurant dining, dedicated gym, and social coffee work areas designed for everyday living in Zanzibar.
            </p>
          </div>

          {/* Lifestyle Scene Switchers */}
            ...
            {LIFESTYLE_SCENES.map((scene) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 text-xs font-sans font-semibold tracking-widest uppercase transition-all border cursor-pointer ${
                    isSelected
                      ? 'bg-[#AE9A7C] text-[#080808] border-[#AE9A7C]'
                      : 'bg-[#171716] text-[#D7D0C5] border-[#D7D0C5]/20 hover:border-[#AE9A7C] hover:text-[#F7F5F0]'
                  }`}
                >
        ...
        {/* Featured Lifestyle Visual Stage */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center bg-[#171716] border border-[#D7D0C5]/10 p-6 sm:p-10 lg:p-12">
          ...
          <div className="lg:col-span-8 relative aspect-[16/10] overflow-hidden bg-[#080808] group">
            <img
              src={ONA_IMAGES[activeScene.imageKey as ImageKey]?.url || ONA_IMAGES.lifestylePool.url}
              alt={ONA_IMAGES[activeScene.imageKey as ImageKey]?.alt || activeScene.title}
              loading="lazy"
            ...
            <div className="absolute top-6 right-6 z-10 bg-[#080808]/80 backdrop-blur-md px-3.5 py-1.5 border border-[#AE9A7C]/40 text-[#AE9A7C] text-[11px] font-sans font-semibold tracking-widest uppercase">
            ...
            <div className="absolute bottom-6 left-6 z-10">
              ...
              <p className="font-display text-2xl sm:text-3xl text-[#F7F5F0] font-semibold">
                {activeScene.title}
              </p>
            </div>
          </div>

          {/* Lifestyle Content & Storytelling */}
          <div className="lg:col-span-4 space-y-6">
            <div>
              <span className="font-sans text-xs font-semibold tracking-[0.24em] text-[#AE9A7C] uppercase block mb-2">
                {activeScene.number} / EXPERIENCE
              </span>
              <h3 className="font-display text-3xl text-[#F7F5F0] font-semibold mb-3 leading-tight">
                {activeScene.title}
              </h3>
            ...
            <div className="pt-6 border-t border-[#D7D0C5]/20">
              <span className="font-sans text-[11px] font-semibold tracking-widest text-[#AE9A7C] uppercase block mb-2">
                Development Amenity
              </span>
              <p className="text-xs text-[#D7D0C5]/90 leading-relaxed font-sans">
                Confirmed lifestyle functions within the ONA Towers development.
              </p>
            </div>
          </div>
        </div>
