...
export const HeroReveal: React.FC<HeroRevealProps> = ({ onLiveClick, onLifeClick, onWorkClick }) => {
  return (
    <section
      id="hero-reveal"
      className="relative w-full bg-[#302A26] text-[#E7DED6] border-t border-[#403832] overflow-hidden py-24 sm:py-32 lg:py-40"
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-16 sm:mb-24">
          ...
          <div className="lg:col-span-4 lg:pt-4">
            <p className="font-sans text-base sm:text-lg text-[#E7DED6] leading-relaxed mb-6 font-light">
        ...
        <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] overflow-hidden bg-[#38312C] rounded-sm border border-[#403832] group mb-16 sm:mb-20 shadow-2xl">
          <img
          ...
          <div className="absolute bottom-6 left-6 sm:bottom-8 sm:left-10 z-10">
            <p className="font-sans text-xs sm:text-sm tracking-[0.2em] uppercase text-[#FFFFFF] font-medium text-shadow-image">
              Architectural Vision &middot; Mazizini Zanzibar
            </p>
            <p className="font-sans text-[11px] text-[#F7F2EC] tracking-wider font-light text-shadow-image">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 pt-8 border-t border-[#403832]">
          {/* Pillar 01 */}
          <button
            id="reveal-pillar-live"
            onClick={onLiveClick}
            className="text-left group cursor-pointer focus:outline-none p-6 rounded-sm bg-[#38312C]/50 border border-[#403832] hover:border-[#A58A71] transition-all"
          >
            <span className="font-sans text-xs font-semibold tracking-[0.2em] text-[#A58A71] uppercase block mb-3">
              01 / LIVE
            </span>
            <h3 className="font-display text-3xl sm:text-4xl text-[#F5F0EA] font-light group-hover:text-[#A58A71] transition-colors mb-2">
              Residences
            </h3>
